...
Page({
  ...
  data: {
    ...
    */
    navs: [
      { id: 1, navName: '我是乘客', tip: '我是乘客', userType: 1, isActive: true },
      { id: 2, navName: '我是司机', tip: '我是司机', userType: 0, isActive: false },
    ],
    userType: 1,
    orderList: [],
    start: 1, // 页码
  ...
  queryList: function () {
    ...
    data.orderUserId = _this.data.userInfo.userId;
